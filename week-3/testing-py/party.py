...
def is_mel(name, email):
    ...
    False
    >>> is_mel('Mel Melitpolski', 'iknowbetter@haha.com')
    True
    >>> is_mel('Totally not Mel', 'mel@ubermelon.com')
    True
    ...
    return name.lower() in "mel melitpolski" or email.lower() in "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    >>> treats=[{'type':'drink'},{'type':'drink'},{'type':'dessert'},{'type':'dessert'},{'type':'alcohol'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'alcohol')
